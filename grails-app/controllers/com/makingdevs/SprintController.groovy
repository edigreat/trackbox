...
class SprintController {
    ...
    def save(Sprint sprintInstance) {
        ...
        sprintInstance.save flush:true//habilita el flush, en ese momento va a la base de datos

        //responde con diferentes formatos, tipos mime
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'sprintInstance.label', default: 'Sprint'), sprintInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'sprintInstance.label', default: 'Sprint'), params.id])
                redirect action: "index", method: "GET"
            }
